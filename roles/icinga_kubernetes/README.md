...
Icinga Kubernetes relies on a relational database to persist received data. This database **won't** be created by this role - you need to deploy and configure one in advance. For more information, see the [Databases](https://github.com/NETWAYS/ansible-collection-icinga/tree/main/doc/getting-started.md#databases) section in the getting started guide.

## Variables

The following variables define the configuration for Icinga Kubernetes. Some variables got predefined [defaults](https://github.com/NETWAYS/ansible-collection-icinga/tree/main/roles/kubernetes/defaults/main.yml), others are purely opt-in.
